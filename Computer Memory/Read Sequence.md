...
3) Sense amplifier activated
	- Once an adequate difference voltage signal between B and B has been developed by the storage cell, the sense amplifier is turned on by connected it to ground and $V_{DD}$ through $Q_{5}$ and $Q_{6}$, activated by raising the sense control signal $\psi$
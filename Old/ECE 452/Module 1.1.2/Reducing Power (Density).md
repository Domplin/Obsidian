- Suppose a new CPU (in scaled technology) has:
	- 85% of capacitive load of old CPU
	- 15% voltage reduction
	- 15% frequency reduction (to Reduce P)
...
- *Also:* we can not reduce voltage significantly
	- As reducing frequency reduces performance

To overcome the "power wall" and improve performance [[The Sea Change]] was the switch from uniprocessors to multiprocessors 

In designing and analyzing filters and resonant circuits or in circuit analysis in general, it is sometimes convenient to work with element values of $1\ohm$, $1H$, or $1F$, and them transform the values to realistic values by **scaling**. We have taken advantage of this idea by not using realistic element values in most of our examples and problems

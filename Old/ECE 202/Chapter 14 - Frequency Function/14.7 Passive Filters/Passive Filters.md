...
A filter is a *passive filter* if it consists only of passive elements R, L, and C. It is said to be an *active filter* if it consists of active elements (transistors, op-amps, etc.) in addition to passive elements 
...
The table shows a summary of the characteristics of these filters. 
![[Table 14.5 Summary of ideal filters.png]]